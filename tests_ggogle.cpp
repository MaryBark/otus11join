...
TEST(join_server_tests, test_symmetric_difference)
{
    ...
    ASSERT_EQ(initTable::symmetric_difference(tables.A, tables.B).data,	symmetric_difference_result.data);
}
...
TEST(join_server_tests, test_intersection)
{
    ...
    ASSERT_EQ(initTable::intersection(tables.A, tables.B).data,	intersection_result.data);
}
...
TEST(join_server_tests, test_output)
{
    ...
    ASSERT_EQ(initTable::intersection(tables.A, tables.B).to_string(), intersection_control);
